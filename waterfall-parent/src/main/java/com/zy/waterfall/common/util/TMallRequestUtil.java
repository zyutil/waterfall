...
//    }
    ...
    public static String getSellerItem(String appKey, String appSecret, String sessionKey, String serverUrl, Map<String, String> params) throws IOException {
        // 公共参数
